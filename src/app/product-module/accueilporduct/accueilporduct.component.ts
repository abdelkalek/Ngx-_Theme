...
@Component({
  selector: 'app-accueilporduct',
  templateUrl: './accueilporduct.component.html',
  styleUrls: ['./accueilporduct.component.scss']
})
export class AccueilporductComponent implements OnInit {
